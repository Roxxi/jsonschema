  ...
  {:scalars
   ...
   #jsonschema.type_system.types.Document{:properties [:a :name],
                                    :map {:a #jsonschema.type_system.types.Document{:properties [:a-collection],
                                                                              :map {:a-collection
                                                                                    #jsonschema.type_system.types.Cllection{:coll-of
                                                                                                                       #jsonschema.type_system.types.Scalar{:type :string}}}},
                                          :name #jsonschema.type_system.types.Scalar{:type :string}}},
   :coll-subdoc
   #jsonschema.type_system.types.Document{:properties [:a :name],
...
(def scalar-types
  {:null #jsonschema.type_system.types.Scalar{:type :null},
   ...
   :real #jsonschema.type_system.types.Scalar{:type :real},
...
(def scalar-scalar-unions
  {:null-string
   ...
   #jsonschema.type_system.types.Union{:union-of #{#jsonschema.type_system.types.Scalar{:type :int}
                                                   #jsonschema.type_system.types.Scalar{:type :string}}},
   :real-string
   #jsonschema.type_system.types.Union{:union-of #{#jsonschema.type_system.types.Scalar{:type :real}
                                             #jsonschema.type_system.types.Scalar{:type :string}}},
   :id-bool
   #jsonschema.type_system.types.Union{:union-of #{#jsonschema.type_system.types.Scalar{:type :bool}
   ...
   :bool-real
   #jsonschema.type_system.types.Union{:union-of #{#jsonschema.type_system.types.Scalar{:type :bool}
                                             #jsonschema.type_system.types.Scalar{:type :real}}},
   :int-null
   #jsonschema.type_system.types.Union{:union-of #{#jsonschema.type_system.types.Scalar{:type :null}
                                                   #jsonschema.type_system.types.Scalar{:type :int}}},
   :real-null
...
;; This creates the cross product of scalar merging test. Currently, we have 7 kinds-
;; so this generates 49 tests
...
(deftest scalar-tests
  (testing "Scalar - Scalar"
    (testing "Tests if the following conditions are true:
      ...
      (gen-scalar-scalar-test [:null :bool :int :date :id :string :real])))
...
(def merged-one-two-type
  #jsonschema.type_system.types.Union{:union-of #{#jsonschema.type_system.types.Document{:properties [:a :b], :map {:a #jsonschema.type_system.types.Collection{:coll-of #jsonschema.type_system.types.Scalar{:type :int}}, :b #jsonschema.type_system.types.Scalar{:type :string}}} #jsonschema.type_system.types.Document{:properties [:a], :map {:a #jsonschema.type_system.types.Collection{:coll-of #jsonschema.type_system.types.Union{:union-of #{#jsonschema.type_system.types.Scalar{:type :null} #jsonschema.type_system.types.Scalar{:type :int}}}}}}}})
